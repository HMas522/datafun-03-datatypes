...
def illustrate_sets():
    ...
    listWords = ["nintendo", "playstation", "xbox", "sega", "gameboy", "pc"]
...
def illustrate_dictionaries():
    ...
    dogA_dict = {"name": "Red XIII", "age": 48, "weight_kg": 13.4}
    dogB_dict = {"name": "Cait Sith", "age": 99, "weight_kg": 15.2}
    ...
    data_dict = {
        "name": ["Cloud", "Aerith", "Sephiroth", "Cid"],
        "age": [21, 22, 30, 32],
        "height": [173, 161, 186, 181],
    }
